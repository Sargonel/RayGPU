...
clean:
	powershell -NoProfile -Command "$$paths = @('main.exe','d3dcompiler_47.dll','build/web'); foreach ($$path in $$paths) { if (Test-Path -LiteralPath $$path) { Remove-Item -LiteralPath $$path -Recurse -Force } }"
